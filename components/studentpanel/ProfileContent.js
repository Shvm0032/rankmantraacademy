          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="email" className="w-full px-4 py-2 border rounded-lg" value="student@edu.com" readOnly />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Mobile</label>
                <input type="tel" className="w-full px-4 py-2 border rounded-lg" value="9876543210" readOnly />
              </div>
            </div>
            
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Address</label>
              <textarea className="w-full px-4 py-2 border rounded-lg" rows="3" readOnly>
