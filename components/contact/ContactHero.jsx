...
export default function ContactHero() {
  return (
       <section
      className="w-full h-[45vh] md:h-[50vh] bg-content bg-center  sm:bg-right bg-no-repeat flex flex-col items-center justify-center px-4 text-white"
    ...
    >
      ...
      <p className="flex items-center gap-2 text-sm md:text-base font-medium">
        ...
        <span className="text-[#032E42]">Contact</span>
      </p>
    </section>
  );
}